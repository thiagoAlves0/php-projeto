  ...
  <h2 class="hover-color">Catálogo de Animes</h2>
    <ul class="anime-list">
      <li class="anime-item">
        ...
        <a href="animesdb.php?anime_id=1" target="_blank">
      ...
      <li class="anime-item">
        ...
        <!-- Link para o vídeo ao clicar na imagem -->
        <a href="animesdb.php?anime_id=2" target="_blank">
      ...
      <li class="anime-item">
        ...
        <!-- Link para o vídeo ao clicar na imagem -->
        <a href="animesdb.php?anime_id=3" target="_blank">
      ...
      <li class="anime-item">
        ...
        <!-- Link para o vídeo ao clicar na imagem -->
        <a href="animesdb.php?anime_id=4" target="_blank">
      ...
      <li class="anime-item">
        ...
        <!-- Link para o vídeo ao clicar na imagem -->
        <a href="animesdb.php?anime_id=5" target="_blank">
      ...
      <li class="anime-item">
        ...
        <!-- Link para o vídeo ao clicar na imagem -->
        <a href="animesdb.php?anime_id=6" target="_blank">
